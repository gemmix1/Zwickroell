# Schutzteile v5:
#  - Kopf_Bruecke: verbindet die beiden Wellen-Enden oben (Presssitz Ã˜7.8),
#    Spindel-Durchlass Ã˜10.5 mittig -> Fingerschutz + versteift die Fuehrung.
...
# ---- Kopf_Bruecke: 60(Y) x 20(X) x 14, Wellenbohrungen (0,+-22) Ã˜7.8 x 10 blind,
#      Spindel-Durchlass Ã˜10.5 durch ----
