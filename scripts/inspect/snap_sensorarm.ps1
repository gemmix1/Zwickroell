...
$file = "H:\ZwickRoell Projekt\Sensorarm.ipt"
...
Save-View "AppIsometricViewCmd" "H:\ZwickRoell Projekt\_sa_iso.png"
Save-View "AppTopViewCmd"        "H:\ZwickRoell Projekt\_sa_top.png"
$doc.Close($true)
Write-Host "ok"
