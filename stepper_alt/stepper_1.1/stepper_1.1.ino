...
//    Tools -> Port  -> COM-Port des Mega auswaehlen
//
...
// ── STEP_DIR Parameter ──────────────────────────────────────
// Mega digitale Pins: 2-13, 22-53  (alle nutzbar)
#if TREIBER_MODUS == STEP_DIR
  #define STEP_PIN          22   // Mega: beliebiger digitaler Pin
  #define DIR_PIN           23
  #define ENA_PIN           24   // auf 255 setzen wenn nicht verwendet
