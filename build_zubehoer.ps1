...
# 1) Taststift Ø4 x 35 + Kragen Ø9 (Schalter-Flag) bei z=25
Write-Host "Teile..."
...
# 4) Servo_SG90: Body 23x12x22 + Welle Ø4.8 x 14 (oben)
$doc=NewPart; $cd=$doc.ComponentDefinition; $XY=$cd.WorkPlanes.Item(3)
...
# 5) Motor_N20_ph: Body 12x12x28 + Welle Ø3 x 12 (oben)
$doc=NewPart; $cd=$doc.ComponentDefinition; $XY=$cd.WorkPlanes.Item(3)
